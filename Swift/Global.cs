...
namespace Swift
{
    public static class Global
    {
        ...
        public enum Token { }
        public enum DataType {Identifier
            , Class, Deinit, Enum, Extension, Func, Import, Init, Inout, Internal, Let, Private, Protocol, Public, Static, Struct, Subscript, Typealias, Var /*Identifiers*/
